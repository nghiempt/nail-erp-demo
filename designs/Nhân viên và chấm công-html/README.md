# Nhân viên và chấm công — design reference
...
- `NhanVien.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `NhanVien.dc.html`;
