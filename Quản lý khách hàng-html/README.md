# Quản lý khách hàng — design reference
...
- `KhachHang.dc.html` — the artboard (a Design Component: an `<x-dc>`
...
Serve the folder (e.g. `python3 -m http.server`) and open `KhachHang.dc.html`;
